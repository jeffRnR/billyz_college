...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $query = "INSERT INTO users (fname, lname, phone_number, email, `password`, id_number, date_of_birth,next_of_kin, next_of_kin_contact, next_of_kin_relationship, `role`, course)
                  VALUES ('$fname', '$lname', '$phone_number', '$email', '$password', '$id_number', '$date_of_birth','$next_of_kin', '$next_of_kin_contact', '$next_of_kin_relationship', 'student', '$selected_course_id')";
...
$user_query = mysqli_query($conn, "SELECT * FROM users WHERE `role`='student' AND user_id LIKE '%$searchTerm%'");
		...
		<main>
			...
			<div class="recent-appointments">
                <div class="coursework_title">
                    <h2>Add Student</h2>
                    <a href="studentList.php" class="staff-btn">See Students</a>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>                            
                            <tr>
                                ...
                                <td><input type="number" id="id_number" name="id_number" required></td>
                                ...
                                <td><input type="text" id="next_of_kin_relationship" name="next_of_kin_relationship" required></td>
                                <td>
		...
		<div class="right">
			...
			<div class="recent-updates">
                ...
                <div class="search-container">
                    <form method="GET" action="student.php" class="attendance_form"> 
					...
					<div class="student_list">
                        <ul class="student">
                            <?php foreach ($user as $user): ?>
                                <li><a href="#"><?= $user['user_id']?> <?= $user['fname']?> <?= $user['lname'] ?></a></li>
                            <?php endforeach; ?>                            
                        </ul>										
					</div>
				</div>		
