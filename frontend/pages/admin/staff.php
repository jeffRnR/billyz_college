...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (!preg_match('/^[A-Z]{2}\d{9}$/', $kra_pin)) {
        $error = "Invalid KRA PIN format.";
    } else {
        $query = "INSERT INTO users (fname, lname, phone_number, email, `password`, id_number, kra_pin, next_of_kin, next_of_kin_contact, next_of_kin_relationship, `role`, course)
                  VALUES ('$fname', '$lname', '$phone_number', '$email', '$password', '$id_number','$kra_pin', '$next_of_kin', '$next_of_kin_contact', '$next_of_kin_relationship', 'staff', '$course')";
		...
		<main>
			...
			<div class="recent-appointments">
                <div class="coursework_title">
                    <h2>Add Staff</h2>
                    <a href="staffList.php" class="staff-btn">See Staff</a>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="number" id="id_number" name="" required></td>
                                <td><input type="text" id="kra_pin" name="kra_pin" ></td>
